import { d as attr_class, c as store_get, u as unsubscribe_stores } from "../../../../chunks/index2.js";
import "dayjs";
...
import { h as showSidebar } from "../../../../chunks/index3.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    $$renderer2.push(`<div${attr_class(`flex flex-col w-full h-screen max-h-[100dvh] transition-width duration-200 ease-in-out ${store_get($$store_subs ??= {}, "$showSidebar", showSidebar) ? "md:max-w-[calc(100%-var(--sidebar-width))]" : ""} max-w-full`)}><div class="flex-1 max-h-full overflow-y-auto">`);
    {
      $$renderer2.push("<!--[-1-->");
      $$renderer2.push(`<div class="w-full h-full flex justify-center items-center">`);
