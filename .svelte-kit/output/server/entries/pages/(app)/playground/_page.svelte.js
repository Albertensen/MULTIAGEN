import "clsx";
import { m as getContext, k as escape_html, c as store_get, a as attr, q as stringify, u as unsubscribe_stores, b as bind_props, f as fallback, e as ensure_array_like, d as attr_class } from "../../../../chunks/index2.js";
...
import { u as user, s as settings, w as models } from "../../../../chunks/index3.js";
import "../../../../chunks/index4.js";
import { C as Collapsible, a as ChevronUp, D as Download } from "../../../../chunks/Download.js";
  ...
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      Modal($$renderer3, {
        ...
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="text-gray-700 dark:text-gray-100"><div class="flex justify-between px-4 pt-3 pb-1"><div class="text-sm font-medium self-center">${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n).t("Controls"))}</div> <button class="self-center rounded-lg p-1 text-gray-500 transition hover:bg-gray-50 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200"${attr("aria-label", store_get($$store_subs ??= {}, "$i18n", i18n).t("Close"))}>`);
          XMark($$renderer4, { className: "size-4" });
          $$renderer4.push(`<!----></button></div> <div class="px-4.5 pb-5 overflow-y-auto max-h-[70vh]">`);
      ...
      $$renderer3.push(`<!----> <div class="flex flex-col justify-between w-full overflow-y-auto h-full"><div class="mx-auto w-full md:px-0 h-full relative"><div class="flex flex-col h-full px-2.5"><div class="flex w-full items-center gap-1.5">`);
      Collapsible($$renderer3, {
        ...
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="flex gap-2 justify-between items-center"><div class="shrink-0 font-normal ml-1.5">${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n).t("System Instructions"))}</div> `);
      ...
      Dropdown($$renderer3, {
        children: ($$renderer4) => {
          $$renderer4.push(`<button class="p-1.5 text-sm font-normal bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 transition rounded-lg"${attr("aria-label", store_get($$store_subs ??= {}, "$i18n", i18n).t("More options"))}>`);
            ...
            DropdownMenu($$renderer4, {
              ...
              children: ($$renderer5) => {
                DropdownSub($$renderer5, {
                  ...
                  children: ($$renderer6) => {
                    $$renderer6.push(`<button class="flex h-[1.6875rem] w-full items-center gap-2 rounded-xl px-2 text-[13px] cursor-pointer select-none hover:bg-gray-50/40 dark:hover:bg-gray-800/40"${attr("disabled", messages.length === 0, true)}><div class="flex items-center line-clamp-1">${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n).t("Export chat (.json)"))}</div></button> <button class="flex h-[1.6875rem] w-full items-center gap-2 rounded-xl px-2 text-[13px] cursor-pointer select-none hover:bg-gray-50/40 dark:hover:bg-gray-800/40"${attr("disabled", messages.length === 0, true)}><div class="flex items-center line-clamp-1">${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n).t("Plain text (.txt)"))}</div></button>`);
                  },
                  $$slots: {
                    default: true,
                    trigger: ($$renderer6) => {
                      $$renderer6.push(`<button slot="trigger" class="flex h-[1.6875rem] w-full items-center gap-2 rounded-xl px-2 text-[13px] cursor-pointer select-none hover:bg-gray-50/40 dark:hover:bg-gray-800/40">`);
      ...
      $$renderer3.push(`</textarea></div> <div class="flex justify-between flex-col sm:flex-row items-start sm:items-center gap-2 mt-2"><div class="shrink-0"><button type="button"${attr_class(`px-3.5 py-1.5 text-sm font-normal bg-gray-50 hover:bg-gray-100 text-gray-900 dark:bg-gray-850 dark:hover:bg-gray-800 dark:text-gray-200 transition rounded-lg shrink-0 ${store_get($$store_subs ??= {}, "$settings", settings)?.highContrastMode ?? false ? "" : "outline-hidden"}`)}${attr("aria-pressed", role === "assistant")}${attr("aria-label", store_get($$store_subs ??= {}, "$i18n", i18n).t("Switch to Assistant role"))}>`);
      {
        $$renderer3.push("<!--[0-->");
      ...
      $$renderer3.push(`</div> <button${attr_class(`p-1.5 text-sm font-normal bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 transition rounded-lg ${showControls ? "text-black dark:text-white" : "text-gray-500 dark:text-gray-400"}`)}${attr("aria-label", store_get($$store_subs ??= {}, "$i18n", i18n).t("Controls"))} id="playground-controls-toggle">`);
      AdjustmentsHorizontal($$renderer3, { className: "size-3.5" });
      $$renderer3.push(`<!----></button> <div class="flex gap-2 shrink-0">`);
      {
        $$renderer3.push("<!--[0-->");
        $$renderer3.push(`<button${attr("disabled", message === "", true)} class="px-3.5 py-1.5 text-sm font-normal disabled:bg-gray-50 dark:disabled:hover:bg-gray-850 disabled:cursor-not-allowed bg-gray-50 hover:bg-gray-100 text-gray-900 dark:bg-gray-850 dark:hover:bg-gray-800 dark:text-gray-200 transition rounded-lg">${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n).t("Add"))}</button> <button class="px-3.5 py-1.5 text-sm font-normal bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-gray-100 transition rounded-lg">${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n).t("Run"))}</button>`);
      }
