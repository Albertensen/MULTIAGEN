import { m as getContext, p as head, d as attr_class, c as store_get, k as escape_html, j as slot, u as unsubscribe_stores } from "../../../../chunks/index2.js";
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class(` flex flex-col w-full h-screen max-h-[100dvh] transition-width duration-200 ease-in-out ${store_get($$store_subs ??= {}, "$showSidebar", showSidebar) ? "md:max-w-[calc(100%-var(--sidebar-width))]" : ""} max-w-full`)}><nav class="px-2.5 pt-1.5 backdrop-blur-xl w-full drag-region"><div class="flex items-center">`);
    if (store_get($$store_subs ??= {}, "$mobile", mobile)) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<div${attr_class(`${store_get($$store_subs ??= {}, "$showSidebar", showSidebar) ? "md:hidden" : ""} flex flex-none items-center self-end mt-1.5`)}>`);
      Tooltip($$renderer2, {
