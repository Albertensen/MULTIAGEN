import { n as noop, f as fallback, b as bind_props, a as attr, e as ensure_array_like, s as sanitize_props, c as store_get, d as attr_class, g as clsx, h as attr_style, i as spread_props, j as slot, k as escape_html, u as unsubscribe_stores, r as rest_props, l as attributes, m as getContext, o as setContext, p as head, q as stringify } from "../../chunks/index2.js";
import "socket.io-client";
import { w as writable } from "../../chunks/index.js";
import { e as exportSingleChatStats, c as config, t as theme, s as settings, W as WEBUI_NAME } from "../../chunks/index3.js";
      ...
      Modal($$renderer3, {
        ...
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full">`);
          {
            ...
            $$renderer4.push(`<!--]--> <div class="mt-4 flex items-center justify-between gap-2"><div class="text-xs text-gray-400 text-center mr-auto"><button class="hover:underline px-2" type="button"${attr("disabled", syncing, true)}>${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n2).t("Download as JSON"))}</button></div> <button class="rounded-full bg-gray-100 px-4 py-2 text-sm font-normal text-gray-600 transition hover:bg-gray-200 disabled:cursor-not-allowed dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700">${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n2).t("Cancel"))}</button> <button class="px-3.5 py-1.5 text-sm font-normal bg-black hover:bg-gray-900 text-white dark:bg-white dark:text-black dark:hover:bg-gray-100 transition-colors rounded-full"${attr("disabled", syncing, true)}>`);
            {
              $$renderer4.push("<!--[-1-->");
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (typeof document !== "undefined") {
      document.documentElement.classList.toggle("high-contrast", store_get($$store_subs ??= {}, "$settings", settings)?.highContrastMode ?? false);
    }
    let $$settled = true;
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      ...
      $$renderer3.push(`<a href="#main-content" class="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-[9999] focus:rounded-lg focus:bg-white focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-gray-900 focus:shadow-lg dark:focus:bg-gray-800 dark:focus:text-gray-100">${escape_html(store_get($$store_subs ??= {}, "$i18n", i18n).t("Skip to main content"))}</a> `);
      {
        $$renderer3.push("<!--[-1-->");
      }
      $$renderer3.push(`<!--]--> `);
      ...
      Toaster($$renderer3, {
        ...
        toastOptions: {
          classes: {
            closeButton: "!bg-white/80 !text-gray-500 !border-gray-200 hover:!bg-gray-50 hover:!text-gray-700 dark:!bg-gray-850 dark:!text-gray-400 dark:!border-gray-700 dark:hover:!bg-gray-800 dark:hover:!text-gray-200"
          }
        }
      });
      $$renderer3.push(`<!---->`);
