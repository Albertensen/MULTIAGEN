...
- [x] Item 35: Workspace Directory UI — **DONE 2026-08-07: FileManagerPanel.svelte (drop zone + daftar file + scope GLOBAL/ISOLATED), routing dir:* → FileManagerPanel, 2 channel direktori per leader, E2E verified**
